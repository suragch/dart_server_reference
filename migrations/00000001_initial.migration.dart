...
class Migration1 extends Migration {
  ...
  Future seed() async {
    final rows = [
      ...
      {
        'word': 'cow',
        'content': '{"description": "large animal you can milk"}'
      },
      {
        'word': 'camel',
        'content': '{"description": "large animal with humps"}'
      },
      {'word': 'sheep', 'content': '{"description": "small animal with wool"}'},
      {'word': 'goat', 'content': '{"description": "small animal with horns"}'},
    ];
